...
@Component({
  selector: 'app-table-with-service',
  templateUrl: './table-with-service.component.html',
  styleUrls: ['./table-with-service.component.scss']
})
export class TableWithServiceComponent implements OnInit {
  dataSource: User[];
  data: User[];
  totalRecords: number;
  loading = true;
